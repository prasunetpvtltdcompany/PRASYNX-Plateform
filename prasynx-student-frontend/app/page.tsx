...
import {
  ...
  Bell, Search, Menu, X, TrendingUp, Users, GraduationCap, Award,
  Clock, CheckCircle2, AlertCircle, Plus, Download, Eye, EyeOff, Edit3, ArrowRight, Loader2,
  Filter, MoreHorizontal, Star, Moon, Sun, HelpCircle, School,
  BarChart3, PieChart, LineChart, ChevronDown, ArrowUpRight,
   QrCode, BookMarked, Trophy,
  ChevronRight, ChevronLeft, Home, Sparkles, Zap, Briefcase,
} from 'lucide-react';
import {
  ...
  const login = async () => {
    ...
    try {
      ...
      if (res.success && res.data) {
        const { token, user, student, teachers } = res.data;
        try {
          const supabase = createClient();
        ...
        authLogin(token, user, student || {}, teachers || []);
      } else {
              ...
              <div className="mt-5 space-y-3">
                <div className="text-center">
                  <p className="text-xs text-[#94A3B8]">
                    ...
                    <Link href="http://localhost:3000/contact" className="font-bold text-blue-600 transition hover:text-blue-700">
                      Contact Support
                    </Link>
                  </p>
                </div>
