          ...
          return (
            <Card key={sub.id || i} className="p-5 bg-white border border-gray-150/80 shadow-sm space-y-4">
              <div className="flex justify-between items-start">
                <Badge className="bg-purple-50 text-purple-750 font-bold border-none text-[10px]">{sub.subject_code || 'SUB-01'}</Badge>
                <span className="text-[10px] font-bold text-gray-400 uppercase">Grade: {sub.grade_level || 'General'}</span>
              </div>
