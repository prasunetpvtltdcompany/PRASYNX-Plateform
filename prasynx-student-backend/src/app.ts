...
import studentRoutesRefactored from './routes/refactored/student.routes';
import studentRoutesLegacy from './routes/index';
...
app.get('/', (req, res) => {
  res.json({ message: 'Student API v2 is running', version: '2.0.0' });
});
