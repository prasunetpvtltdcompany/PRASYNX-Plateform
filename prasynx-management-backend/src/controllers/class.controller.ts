...
export class ClassController {
  ...
  async assignStudent(req: AuthRequest, res: Response) {
    ...
    const result = await classService.assignStudent(class_id, student_id);
  ...
  async assignStudentsBulk(req: AuthRequest, res: Response) {
    ...
    const result = await classService.assignStudentsBulk(class_id, student_ids);
  ...
  async assignClassTeacher(req: AuthRequest, res: Response) {
    ...
    const result = await classService.assignClassTeacher(class_id, teacher_id, req.user?.organisationId);
    sendSuccess(res, result);
  }

  async assignAssistantTeacher(req: AuthRequest, res: Response) {
    const { class_id, teacher_id } = req.params;
    const result = await classService.assignAssistantTeacher(class_id, teacher_id, req.user?.organisationId);
    sendSuccess(res, result);
  }
