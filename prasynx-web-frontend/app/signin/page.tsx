...
import { GraduationCap, Users, BookOpen, Briefcase, Shield, ArrowRight, Sparkles, CheckCircle2, ChevronRight } from 'lucide-react';
...
const portals = [
  ...
  {
    id: 'recruiter',
    name: 'Job Provider Portal',
    description: 'Hire verified students and graduates using AI-powered recruitment tools.',
    icon: Briefcase,
    color: '#6366F1',
    bgLight: 'bg-indigo-50',
    features: ['Job Posting', 'Candidate Search', 'ATS', 'Resume Screening', 'Analytics'],
  ...
  },
  {
    ...
    description: 'Manage schools, campuses, users, permissions, compliance, and reporting.',
    icon: Shield,
    color: '#7C3AED',
    bgLight: 'bg-purple-50',
    features: ['User Management', 'Security', 'Compliance', 'Reports', 'Analytics'],
