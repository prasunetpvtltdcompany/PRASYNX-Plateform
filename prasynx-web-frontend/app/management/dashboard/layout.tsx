      ...
      <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-[#E2E8F0] bg-white">
        ...
        <nav className="flex-1 space-y-1 p-4">
          {[
            ...
            { href: '/management/finance', label: 'Finance' },
        ...
        <div className="border-t border-[#E2E8F0] p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-xs font-bold text-slate-900">Management</p>
              <p className="text-[10px] text-slate-500 capitalize">Institution</p>
            </div>
          </div>
        </div>
      </aside>
