...
import {
  Activity, ArrowRight, ArrowUpRight, AtSign, BarChart3, BookOpen, BookOpenText, Briefcase,
  Building2, CheckCircle, ChevronDown, Cloud, ExternalLink, FileText, Globe,
  GraduationCap, Heart, Layers, LifeBuoy, Lock, Mail, MapPin,
  Menu, MessageCircle, Monitor, Phone, Search, Server, Share2, Shield, Smartphone, Sparkles,
...
const navLinks = [
  { href: '/', label: 'Home' },
  {
    ...
    badge: 'New',
    menu: [
      { href: '/student', label: 'Student Portal', description: 'AI-powered learning, grades, attendance & career guidance.', icon: GraduationCap },
      { href: '/parent', label: 'Parent Portal', description: 'Real-time updates, fee management & teacher communication.', icon: Users },
      { href: '/staff', label: 'Staff Portal', description: 'Class management, assessments & performance analytics.', icon: BarChart3 },
      { href: '/job-provider', label: 'Job Provider Portal', description: 'AI recruitment, applicant tracking & hiring analytics.', icon: Briefcase },
      { href: '/admin', label: 'Management Portal', description: 'Multi-campus control, RBAC & compliance reporting.', icon: Shield },
    ],
  },
  ...
  columns: [
    {
      title: 'Platform', icon: Cloud, items: [
        { href: '/student', label: 'Student Portal' }, { href: '/parent', label: 'Parent Portal' },
        { href: '/staff', label: 'Staff Portal' }, { href: '/job-provider', label: 'Job Provider Portal' },
        { href: '/admin', label: 'Management Portal' },
    ...
    <div className="min-h-screen" style={{ background: '#F8FAFF' }}>
      ...
      <footer className="relative overflow-hidden border-0 bg-white px-4 py-16 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(180deg, #FFFFFF 0%, #F8FAFF 40%, #F4F1FF 70%, #FFFFFF 100%)' }}>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={{ visible: { transition: { staggerChildren: 0.03 } } }}
          ...
          <motion.div variants={staggerItem} custom={6} className="relative mt-16 overflow-hidden rounded-2xl border border-[#6C4CF1]/20 bg-gradient-to-br from-white via-[#F8FAFF] to-white p-6 shadow-lg shadow-[#6C4CF1]/5 sm:p-8">
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-gradient-to-br from-[#6C4CF1]/15 to-transparent blur-2xl" />
              <div className="absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-gradient-to-tr from-[#A855F7]/10 to-transparent blur-2xl" />
            </div>
            <div className="relative flex flex-col items-start gap-6 sm:flex-row sm:items-center">
              <div className="shrink-0">
                <div className="relative">
                  <div className="absolute -inset-3 rounded-full bg-gradient-to-r from-[#6C4CF1]/20 to-[#8B5CF6]/20 blur-md" />
                  <div className="relative grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-[#6C4CF1] to-[#8B5CF6] shadow-lg shadow-[#6C4CF1]/25">
                    <img src="/prerana-ai.png" alt="Prerana AI" className="h-10 w-10 object-contain" />
                  </div>
                </div>
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-extrabold" style={{ color: '#0F172A' }}>Prerana AI</h3>
                <p className="mt-1 text-sm font-semibold" style={{ color: '#6C4CF1' }}>Your Intelligent Educational Assistant</p>
                <p className="mt-1.5 max-w-xl text-sm leading-relaxed" style={{ color: '#64748B' }}>
                  Get instant support, AI-powered guidance, automation assistance, and smart recommendations across the entire Prasynx ecosystem.
                </p>
              </div>
              <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                <Link href="/prerana" className="group/btn inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#6C4CF1] to-[#8B5CF6] px-6 py-2.5 text-sm font-bold text-white shadow-md shadow-[#6C4CF1]/20 transition-all hover:shadow-lg hover:shadow-[#6C4CF1]/30 hover:-translate-y-0.5 active:scale-[0.98]">
                  Chat with Prerana AI
                  <MessageCircle size={16} className="transition-transform group-hover/btn:scale-110" />
                </Link>
                <Link href="/prerana" className="group/btn inline-flex items-center gap-2 rounded-xl border border-[#E2E8F0] bg-white/80 px-6 py-2.5 text-sm font-bold backdrop-blur-sm transition-all hover:border-[#6C4CF1]/30 hover:bg-white hover:shadow-md" style={{ color: '#475569' }}>
                  Learn More
